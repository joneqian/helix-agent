...
| | 旧 | 新 | T0+T1 | +T2 | +8.5 | +13.2 | +14.4 | +9.4 |
|---|---|---|---|---|---|---|---|---|
| 总分 | 388/430 | **396/430** | **402/430** | **404/430** | **406/430** | **408/430** | **410/430** | **413/430** |
| 百分 | 90.2% | **92.1%** | **93.5%** | **93.95%** | **94.4%** | **94.9%** | **95.3%** | **96.0%** |
| 均分 | 4.51 | **4.60** | **4.67** | **4.70** | **4.72** | **4.74** | **4.77** | **4.80** |
...
**域9 持久化 4.00→4.50**(9.4 ★2→★5 failover,live 实证,#677+#678)。其余 8 域不变。
...
- **未变的 design-only 风险项**：9.5(分布式队列,M1)/12.4(计费业务层)/16.3/16.4(基础设施自愈)——均诚实标
  ≤★3 且有明确 M1/业务层归属,非静默缺失。（9.4 failover 已 ★2→★5 live 收口,#677+#678;3.3/13.2/14.4
  亦已先后清。）
...
- M1 真大头：9.5 分布式队列、12.4 计费业务层、16.3/16.4 基础设施自愈、7.6 IDS（9.4 failover/14.4 MCP 审计已清）
