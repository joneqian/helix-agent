...
- [ ] **H.4 治理面（Memory / Curation+Eval / Skills / Triggers / Settings IAM+Ops / Audit）**：跨 agent / 跨 user 治理视图。复刻 H.3 范式 — PR 0 = 纯设计文档 + 6 张 mockup,合入后开 8 个实施 PR + 1 个收尾。**2026-05-26 PR 0 设计基线 ready**(STREAM-H-DESIGN § 6.6 18 子章节 + mockup 09–14)。Backend 6 个子面已 shipped(K.6 / J.12 / J.7 / J.10 / C/D/F/G),Audit endpoint(`GET /v1/audit`) 在 H.4 PR 3 新建。总估时 14–18 天
