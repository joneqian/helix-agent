...
export const WORKSPACE_ITEMS: readonly NavEntry[] = [
  { key: "agents", labelKey: "nav.agents", path: "/agents", group: "workspace" },
  { key: "runs", labelKey: "nav.runs", path: "/runs", group: "workspace" },
  { key: "approvals", labelKey: "nav.approvals", path: "/approvals", group: "workspace", badge: true },
  { key: "curation", labelKey: "nav.curation", path: "/curation", group: "workspace" },
  { key: "eval", labelKey: "nav.eval", path: "/eval-runs", group: "workspace" },
  { key: "memory", labelKey: "nav.memory", path: "/memory", group: "workspace" },
...
export const TENANT_SETTINGS_ITEMS: readonly NavEntry[] = [
  { key: "settings-members", labelKey: "nav.members", path: "/settings/members", group: "tenant-settings" },
  { key: "settings-credentials", labelKey: "nav.credentials", path: "/settings/credentials", group: "tenant-settings" },
  { key: "settings-api-keys", labelKey: "nav.api_keys", path: "/settings/api-keys", group: "tenant-settings" },
...
export const PLATFORM_ITEMS: readonly NavEntry[] = [
  { key: "settings-tenants", labelKey: "nav.tenants", path: "/settings/tenants", group: "platform" },
  { key: "settings-platform-users", labelKey: "nav.platform_users", path: "/settings/platform-users", group: "platform" },
  { key: "settings-platform", labelKey: "nav.platform_credentials", path: "/settings/platform", group: "platform" },
  { key: "settings-mcp-catalog", labelKey: "nav.mcp_catalog", path: "/settings/mcp-catalog", group: "platform" },
  { key: "settings-platform-skills", labelKey: "nav.platform_skills", path: "/settings/platform-skills", group: "platform" },
  { key: "settings-rate-card", labelKey: "nav.rate_card", path: "/settings/rate-card", group: "platform" },
  { key: "settings-chargeback", labelKey: "nav.chargeback", path: "/settings/billing-chargeback", group: "platform" },
  // Read-only cross-tenant overview — reuses the members page under the
  // ``"*"`` scope (already renders read-only there). §2-C / §8 point 2.
  { key: "platform-members-all", labelKey: "nav.members_all_tenants", path: "/settings/members", group: "platform" },
];
