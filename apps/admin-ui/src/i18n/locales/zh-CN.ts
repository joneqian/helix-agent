...
const zhCN: TranslationKeys = {
  ...
  knowledge_page: {
    ...
    embedding_unset: "未设置",
    needs_reindex_banner: "平台 embedding 模型在本库建索引后发生了变化。请重建索引以保证检索准确。",
    reindex_button: "重建索引",
    reindex_started: "已开始重建索引，将在后台运行。",
    upload_dragger_hint: "点击或拖拽文件到此上传",
    upload_dragger_sub: "支持 PDF、Office、Markdown、HTML、CSV、TXT，可多文件。",
    col_attempts: "尝试次数",
    reingest: "重新摄取",
    ...
    test_run: "运行",
    test_empty_hint: "运行查询预览检索效果——按相关度排序的分块,含分数与召回路径。",
